[![REUSE status](https://api.reuse.software/badge/github.com/open-crypto-broker/crypto-broker-server)](https://api.reuse.software/info/github.com/open-crypto-broker/crypto-broker-server)

# crypto-broker-server

## About this project

The broker server, written in Go. Combined with the client libraries to execute cryptographic functions based on different profiles.
