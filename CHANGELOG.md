...
- Upgrade go version to 1.26.6 (#149)
- Add dependabot submodule check (#147)

### 🐛 Bug Fixes

- Adjust gitsubmodule path (#148)

### ⚙️ Miscellaneous Tasks

- Remove OCM variable (#146)
...
- Update grpc-health-probe dependency in Dockerfile (#115)
